...
def azurerm_host(resource, module_name):
    ...
    attrs = {
        ...
        'ansible_user': raw_attrs.get('tags.remote_user', ''),
        'ansible_host': raw_attrs.get('tags.remote_ip', ''),
...
def main():
    ...
    default_root = os.path.abspath(os.path.join(os.path.dirname(__file__),"..","infra"))
